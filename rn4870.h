...
public:
    ...
    void begin(char *buffer, int bufferLen,HardwareSerial *antenna=&BLE, long baudrate=115200);
#elif defined (ASME3_REVISION)
    void begin(char *buffer, int bufferLen,HardwareSerial *antenna=&BLE, long baudrate=115200);
#else
    void begin(char *buffer, int bufferLen,HardwareSerial *antenna=&Serial1, long baudrate=115200);
#endif
